...
CREATE TABLE `NotificationTemplates` (
  ...
  `typeOfTemplate` enum('submission', 'report','review','error','reminder','warning','request') NOT NULL,
  KEY `not_temp_idx` (`templateId`),
  KEY `not_type_idx` (`typeOfTemplate`),
  CONSTRAINT `noti_temp` FOREIGN KEY (`templateId`) REFERENCES `Templates` (`templateId`)
